...
const StudioDashboard = () => {
  return (
    ...
    >
      {/* Welcome Text */}
      <h2 className="text-[24px] md:text-[28.88px] font-extrabold text-[#CCE7F6] mb-1 text-start">
        Welcome Neeraj,
      </h2>
      <p className="text-[13px] md:text-[14px] text-[#B0B0B0] mb-6 text-start">
        Summary of your albums, usage, and quick actions.
      </p>

      {/* Cards Section */}
      <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 lg:grid-rows-5 gap-4 mb-10">
        {/* Total Credits Card */}
        <div className="bg-[#002D4C] rounded-[14px] p-4 flex flex-col items-center gap-4 border border-white/10 
          ...
          <img src={atmCard} alt="Credits Icon" className="w-[40px] md:w-[45.45px] h-[40px] md:h-[45.45px]" />
        ...
        {/* Reminder Card */}
        <div className="bg-[#002D4C] rounded-[14px] p-4 flex flex-col items-center gap-4 border border-white/10 
                        sm:col-span-1 lg:col-span-2 lg:row-span-2 lg:col-start-1 lg:row-start-3">
          <img src={bellIcon} alt="Bell Icon" className="w-[36px] md:w-[40px] h-[36px] md:h-[40px]" />
          <div className="text-center lg:text-start">
        ...
        <div className="bg-[#002D4C] rounded-[14px] p-4 border border-white/10 
                        sm:col-span-2 lg:col-span-3 lg:row-span-4 lg:col-start-3 lg:row-start-1">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <h3 className="text-[16px] font-semibold">Activity Feed</h3>
            <img src={activityIcon} alt="Activity Icon" className="w-[64px] md:w-[84.15px] h-[64px] md:h-[84.15px]" />
          </div>
          <p className="text-[13px] text-white text-start mb-3">
            You created <span className="text-[#fff] font-medium">‘Wedding__Ravi2025’</span> –{' '}
            <span className="text-[#A9A9A9]">2 days ago</span>
          </p>
          <p className="text-[13px] text-white text-start mb-3">
            Album <span className="text-[#fff] font-medium">‘Portfolio__Models’</span> got 38 new views
          </p>
          <p className="text-[13px] text-white text-start">
      ...
      <div className="w-full rounded-[25px] mx-auto mb-16 px-4 md:px-10 py-8 border border-[#244E64]">
        <h2 className="text-white text-[18px] md:text-[22px] font-semibold mb-6 text-start">
          Search Your Album
        </h2>
