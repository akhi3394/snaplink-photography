...
const LabSupportContact = () => {
  return (
    <div className="min-h-screen text-white font-rubik backdrop-blur-[2px] bg-cover bg-no-repeat px-4 md:px-8 py-6" style={{ backgroundImage: `url('/bg-pattern.svg')` }}>
      <h2 className="text-[28.88px] font-extrabold text-[#CCE7F6]  mb-4 text-start">Support</h2>
      <div className="flex w-full gap-20 mb-3">
        <p className='bg-[#E3E3E326] w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3'>About Us</p>
        <p className='bg-[#E3E3E326] w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3'>Terms & Condition</p>
      </div>
      <div className="flex w-full gap-20 mb-3">
        <p className='bg-[#E3E3E326] w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3'>Hyper Guidelines</p>
        <p className='bg-[#E3E3E326] w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3'>Refund/Cancel Policy</p>
      </div>
      <div className="flex w-full gap-20 mb-10">
        <p className='bg-[#E3E3E326] w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3'>Privacy Policy</p>
        <p className='bg-[#E3E3E326] w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3'>FAQ</p>
      </div>

      <h2
        className="text-[18px] font-semibold text-[#CCE7F6] px-5 rounded-[9px] py-4 mb-10 text-start"
        style={{
          background: "linear-gradient(90deg, rgba(32, 37, 126, 0.46) 0%, rgba(11, 14, 81, 0.46) 100%)",
        }}
      >
        Contact us
      </h2>
      ...
      <div className="flex gap-10">
        {/* Contact Info */}
        <div className="grid grid-cols-1 gap-4 mb-6 w-1/2">
          {[
            {
              icon: phone,
              label: 'Phone',
        ...
        <div className="bg-transparent w-1/2">
          ...
          <form className="gap-8">
            ...
            <div className="w-1/4">
              <button
                type="submit"
                className="w-28 py-2 bg-[#CCE7F6] text-[#070B67] border border-[#2C00BE] rounded-[45px] font-rubik hover:bg-[#0ea5e9] transition flex justify-center"
              >
                Submit
              </button>
            </div>
...
export default LabSupportContact;