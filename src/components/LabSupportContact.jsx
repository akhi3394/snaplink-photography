...
const LabSupportContact = () => {
  return (
    ...
    >
      ...
      {/* Top Links */}
      <div className="flex flex-col md:flex-row w-full gap-4 md:gap-20 mb-3">
      ...
      <div className="flex flex-col md:flex-row w-full gap-4 md:gap-20 mb-10">
        <p className="bg-[#E3E3E326] w-full md:w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3">
          Privacy Policy
        </p>
        <p className="bg-[#E3E3E326] w-full md:w-1/2 py-4 rounded-[12px] text-[18px] text-start px-3">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        {/* Contact Info */}
        <div className="grid grid-cols-1 gap-4 mb-6 w-full md:w-1/2">
          {[
            { icon: phone, label: 'Phone', text: '+91 89336 92152' },
            { icon: email, label: 'Email', text: 'support@companyemail.com' },
            { icon: Location, label: 'Address', text: 'Address Company Address Here with PIN' },
          ].map((item, index) => (
            <div
              key={index}
        ...
        {/* Form */}
        <div className="bg-transparent w-full md:w-1/2">
          ...
          <form className="gap-8">
            ...
            <div className="flex justify-center md:justify-start">
              <button
                type="submit"
                className="w-full md:w-28 py-2 bg-[#CCE7F6] text-[#070B67] border border-[#2C00BE] rounded-[45px] font-rubik hover:bg-[#0ea5e9] transition"
              >
                Submit
              </button>
            </div>
